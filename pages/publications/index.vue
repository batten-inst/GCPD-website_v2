      ...
      div(v-for="(pub, i) in publications" :key="i")
        div.bg-orange-50
          .uk-card-body
            ...
            img.uk-width-small.uk-margin-bottom(:src="pub.imgSrc" :alt="pub.publication").uk-float-right.uk-margin-left
            p.uk-text-large.fg-blue-700.uk-margin-remove {{ pub.title }}
