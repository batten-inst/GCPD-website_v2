      ...
      div(class="uk-width-3-4@m uk-flex-last@m")
        div.uk-grid.uk-flex-bottom(uk-grid)
          div(
            ...
            data-step=2
            data-intro="Select a region/country and a sector. <br><br> The data and visuals will change to reflect your selection."
            )
          ...
          div(
            ...
            data-step=3 
            data-intro="Filter the data by patent grant years. Select a range or a single year."
            )
            input-range(
          ...
          div(
            class="uk-width-1-4@m"
            data-step=7 
            data-intro="You can show this guide again. <br><br>At any point, you can reset the data and map to its beginning state using the reset button."
            )
        ...
        hr    
        p(class="uk-hidden@s").uk-padding-remove This page works better on a larger screen. On a small screen, you can see other regions of the map by dragging it. 
        .uk-card.uk-card-small.uk-width-1-1#map-card(
          ...
          div.uk-padding-tiny
            p.uk-h5.uk-margin-remove Countries ranked for the selected sector(s) and year(s)
            div.uk-text-meta 
              p.uk-margin-remove Click on a circle to see that country's top companies.
              p.uk-margin-remove Ranking is within region if a region is selected. 
          
          map-with-circles.uk-align-center
          
          p.uk-margin-small.uk-text-meta.uk-padding-tiny
            | Circle sizes rescale based on selected data. You can zoom in by double clicking and pan by dragging the map. Use the reset button to get back to full view. See sector classification details <nuxt-link to="/data-highlights/note-sector-classification">here </nuxt-link>
